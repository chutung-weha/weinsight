      ...
      <div className="w-full max-w-sm">
        ...
        <div className="glass p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white text-[#1E293B] font-semibold text-sm hover:bg-slate-100 hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300"
          >
