...
export const metadata: Metadata = {
  title: "Chọn bài test — WE INSIGHT",
  description: "Đánh giá năng lực nhân sự qua 3 bài test: DISC (tính cách), Logic (tư duy), Situation (xử lý tình huống).",
  openGraph: {
    title: "Chọn bài test — WE INSIGHT",
    description: "Đánh giá năng lực nhân sự qua 3 bài test: DISC, Logic, Situation.",
  },
};
        ...
        <div className="max-w-[1128px] mx-auto px-6 relative">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-slate-400 max-w-md mx-auto text-sm leading-relaxed">
              Mỗi bài test đo lường một khía cạnh khác nhau. Hoàn thành cả 3 để có bức tranh toàn diện nhất về năng lực của bạn.
            </p>
          </div>
